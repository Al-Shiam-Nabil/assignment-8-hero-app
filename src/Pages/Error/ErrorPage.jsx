...
<Container>
   <div className='grid place-items-center mt-10 mb-20'>
     <img src={errorPageImage} alt="error page image"  className='max-w-[300px] max-h-[300px] object-contain mb-5'/>
    <h2 className='text-3xl font-semibold'>Oops, page not found!</h2>
    <p className='text-gray-500 my-2'>The page you are looking for is not available.</p>
