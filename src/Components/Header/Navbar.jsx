...
const Navbar = () => {
  ...
  <div className="navbar-start">
   ...
   <Link to="/" className='text-[#632EE3] text-lg font-bold flex justify-center items-center gap-1'><img src={logo} alt="Logo" className='w-10 h-10 object-contain' /> HERO.IO</Link>
  </div>
