  ...
  return (
    <Container>
      <div className="text-center space-y-6 mt-16 mb-10">
        ...
        <p className="text-[#627382] sm:text-xl max-w-[1100px] mx-auto">
        ...
        <div className="flex justify-center items-center gap-4 flex-wrap">
          <Link to="https://play.google.com/store/apps?hl=en" target="_blank">
            <button className="flex justify-center items-center gap-2 btn btn-neutral btn-outline hover:shadow-none py-5 border-gray-300 text-lg font-semibold w-[180px]">
              <img
                src={playStoreIcon}
                alt="play store icon"
